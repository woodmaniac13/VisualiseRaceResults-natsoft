...
const ROUND2 = buildRound(
  ...
  },
  {
    ...
    712: 62.112, //            P5 — Malcolm Michel (estimated; faster than Hu at Wakefield)
    544: 61.534, //            P6 — Matthew Cole (estimated)
    34:  61.923, //            P7 — Kim Tai (estimated)
    519: 62.456, //            P8 — Sicheng Hu (estimated)
...
const ROUND3 = buildRound(
  ...
  },
  {
    ...
    60:  65.234, //            P3 — Daniel Nolan (estimated; formula car quick at Druitt)
...
const ROUND4 = buildRound(
  ...
  },
  {
    ...
    666: 96.312, // 1:36.312  P2 — Adam Savic (official: ~1:36.3)
    818: 97.045, //            P3 — Reuben Mardan (official: listed 3rd)
    519: 97.834, //            P4 — Sicheng Hu (official: listed 4th)
    34:  98.498, // 1:38.498  P5 — Kim Tai (official: ~1:38.9)
    62:  98.734, //            P6 — Aristo Pieratos (estimated; likely attended)
    60:  99.012, //            P7 — Daniel Nolan (estimated)
    544: 99.234, //            P8 — Matthew Cole (estimated)
    717: 99.812, //            P9 — Jack Shea (estimated)
    712: 100.534, //           P10 — Malcolm Michel (estimated)
    943: 101.234  //           P11 — Troy Patterson (estimated)
  }
);
